...
setup(
  ...
  download_url = 'https://github.com/tytusdunin/kokosznicka/archive/refs/tags/v0.1.tar.gz',    # I explain this later on
  keywords = ['npl', 'syllabification', 'hyphenation', 'polish'],
  install_requires=[
          're',
      ],
  classifiers=[
